      ...
      <div className="max-w-4xl mx-auto mt-8 bg-white p-6 shadow-md rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p><strong>Type of Desk:</strong> {specifications?.deskType}</p>
            <p><strong>Desk Features:</strong> {specifications?.features.map(feature => `${feature} `)}</p>
            <p><strong>Quantity:</strong> {specifications?.quantity}</p>
