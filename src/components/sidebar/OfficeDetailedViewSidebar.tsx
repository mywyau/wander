...
export default function OfficeDetailedViewSidebar({ isOpen, businessId, officeId }: { isOpen: boolean, businessId: string, officeId: string }) {
                    ...
                    <li>
...

                        {
                            expandedSections.desks && !isCollapsed && (
                                <ul className="pl-4 space-y-4">
                                    <li>
                                        <Link href={`/desk-listing/view-all/${businessId}/${officeId}`} className="hover:text-indigo-700">
