                ...
                <ul className="space-y-2 font-medium">
                    <li>
                        ...
                        <Link
                            ...
                            className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white group hover:text-indigo-700"
                        >
                            <span className={`${isCollapsed ? "hidden" : ""} ms-3`}>Time Selection</span>
                        </Link>
                        <Link
                            href="/wanderer/account/profile"
                            className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white group hover:text-indigo-700"
                        >
                            <span className={`${isCollapsed ? "hidden" : ""} ms-3`}>Wanderer Profile</span>
                        </Link>
                        <Link
                            href="/wanderer/home"
                            className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white group hover:text-indigo-700"
                        >
                            <span className={`${isCollapsed ? "hidden" : ""} ms-3`}>Wanderer QR Code</span>
                        </Link>
                        <Link
                            href="/"
                            className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white group hover:text-indigo-700"
