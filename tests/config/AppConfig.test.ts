...
//TODO: Rewrite this to check the json config
// describe('AppConfig', () => {
...
//     expect(AppConfig.baseCashewUrl()).toBe("cashew:8080");
//   });
...
//     expect(AppConfig.localOrTraefikBaseUrl).toBe(false); 
//     expect(AppConfig.baseCashewUrl()).toBe(""); 
//   });
...
//     // expect(AppConfig.useDockerCashew).toBe(true);
//     expect(AppConfig.basePistachioUrl()).toBe("pistachio.api");
...
//     // expect(AppConfig.useDockerCashew).toBe(true);
//     expect(AppConfig.basePeanutUrl()).toBe("peanut:1012");
//     expect(AppConfig.basePeanutUrl()).toBe("localhost:1012");
//   });
// });
