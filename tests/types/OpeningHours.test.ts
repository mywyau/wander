import { isDeserializationError, OpeningHours } from '@/types/OpeningHours';
...
describe('OpeningHours serialization and deserialization', () => {
    ...
    it('should serialize and deserialize OpeningHours correctly', () => {
        ...
        // expect(json).toBe('{"openingTime":"09:00","closingTime":"17:00"}');
    ...
    //     expect(json).toBe('{"openingTime":"00:00","closingTime":"00:30"}');
